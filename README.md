	...
	Themes = {
		Darker = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 80)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 0, 80)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 80))
			}),
			["Color Hub 2"] = Color3.fromRGB(0, 0, 60),
			["Color Stroke"] = Color3.fromRGB(0, 0, 50),  -- باقي مثل ما هو
			["Color Theme"] = Color3.fromRGB(0, 0, 40),  -- باقي مثل ما هو
			["Color Text"] = Color3.fromRGB(135, 206, 235),
			["Color Dark Text"] = Color3.fromRGB(135, 206, 235)
		},
		Dark = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)),  -- يبقى أبيض
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(135, 206, 235)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255))   -- يبقى أبيض
			}),
			["Color Hub 2"] = Color3.fromRGB(255, 255, 255),  -- يبقى أبيض
			["Color Stroke"] = Color3.fromRGB(135, 206, 235), -- رمادي صار سماوي
			["Color Theme"] = Color3.fromRGB(135, 206, 235),  -- رمادي صار سماوي
			["Color Text"] = Color3.fromRGB(135, 206, 235),
			["Color Dark Text"] = Color3.fromRGB(135, 206, 235)
		},
		Purple = {
...
function redzlib:SetTheme(NewTheme)
	...
	SaveJson("Nexus library V1.json", redzlib.Save)  -- NEXUS 
...
local function SpawnCyberpunkSystem()
	...
	JoinButton.Activated:Connect(function()
		...
		SetProps(JoinButton, {
			...
			BackgroundColor3 = Color3.fromRGB(90, 40, 150),
